...
基於極限梯度提升的新進玩家流失預測模型應用於手機免費遊戲數據集
}

% 論文題目 (英文)
\renewcommand\eTitle{%My Thesis Title  
New Player Churn Prediction Model Based On Extreme Gradient Boosting Is Applied to Mobile Free-to-Play Game Dataset
